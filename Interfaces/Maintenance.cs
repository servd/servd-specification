...
namespace ServD.Interface
{
	...
	public interface Maintenance
	{
		...
		///// <returns>An Update record result that indicates the update status</returns>
		//[OperationContract]
		//UpdateRecordResult AddServiceSiteProvider(ServiceSiteProvider details, string APIkey);
		...
		///// <returns>An Update record result that indicates the update status</returns>
		//[OperationContract]
		//UpdateRecordResult UpdateServiceSiteProvider(ServiceSiteProvider details, string APIkey);
	}
	...
	/// this value to CompleteAndRequiresModeration, and the Update result will be 
	/// <b>SuccessRequiresModeration</b>)</example>
	[ServiceContract(Namespace = Constants.ServDBeta1Namespace, Name="Maintenance")]
	public interface MaintenanceLegacy
	{
		/// <summary>
		/// Add a new Organization. This will always create an un-approved Organization record.
		/// Organization records must be approved by the ServD Operator after they have
		...
		/// The ID of the Organization to add the Site to.
		/// </param>
		/// <param name="details">
		/// The details of the Site to be added.<br/>
		/// All object Identifiers (not the Identifiers Collection Objects) must be null, and External Identifiers
		...
		/// </returns>
		[OperationContract]
		UpdateRecordResult[] SiteAdd(string OrganizationId, Site details, string APIkey);
		...
		/// </summary>
		/// <param name="SiteId">
		/// The Identifier of the Site to associate this Service Site.
		/// </param>
		/// <param name="details">
		/// The details of the Service Site to be added.<br/>
		/// All object Identifiers (not the Identifiers Collection Objects) must be null, and External Identifiers
		...
		/// </returns>
		[OperationContract]
		UpdateRecordResult[] ServiceSiteAdd(String SiteId, ServiceSite details, string APIkey);
