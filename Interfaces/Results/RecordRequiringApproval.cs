...
namespace ServD.Results
{
	...
	public class RecordRequiringApproval
	{
		...
		/// <summary>
		/// The Record Index of the record that can be loaded from the RetrieveDetails interface.
		/// </summary>
		/// <example>
		/// For an Organization Address this would contain the Organization’s Index
		/// </example>
		[DataMember]
		public ServD.Parameters.RecordIndex Parent { get; set; }
	}
}
